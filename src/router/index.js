    ...
    children: [
      {
        path: 'list',
        name: '用户列表',
        component: () => import('@/views/edu/user/index'),
        meta: { title: '用户列表', icon: 'table' }
      },
      {
        path: 'import',
        name: '批量导入用户',
        component: () => import('@/views/edu/user/import'),
        meta: { title: '批量导入用户', icon: 'tree' }
      }
    ]
  },
    ...
    children: [
      {
        path: 'uploadLunbotu',
        name: '上传轮播图',
        component: () => import('@/views/edu/homeinfo/lunbotu/upload'),
        meta: { title: '上传轮播图', icon: 'table' }
      }
    ]
  },
