<template>
  ...
  <el-form :inline="true" class="demo-form-inline">
    ...
    <el-form-item label="购买数量">
      <el-input v-model="searchObj.buyCount" placeholder="购买数量"/>
    </el-form-item>
    <!--浏览数量-->
    <!--<el-form-item label="浏览数量">
      <el-input v-model="searchObj.viewCount" placeholder="浏览数量"/>
    </el-form-item>-->
    <!-- 讲师 -->
    <!--<el-form-item>
      <el-select
    ...
    export default {
      ...
      methods: {
        ...
        getCoursePage(page=1){
          this.page = page
          course.getConditionCoursePageList(this.page,this.limit,this.searchObj)
            .then(resp => {
              //赋值条目具体信息
